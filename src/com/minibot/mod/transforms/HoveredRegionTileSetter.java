...
public class HoveredRegionTileSetter implements Transform {
    ...
    public void inject(Map<String, ClassNode> classes) {
        ...
        xSetter.instructions.add(new FieldInsnNode(PUTSTATIC, xHook.getClazz(), xHook.getField(), xHook.getFieldDesc()));
        ...
        ySetter.instructions.add(new FieldInsnNode(PUTSTATIC, yHook.getClazz(), yHook.getField(), yHook.getFieldDesc()));
